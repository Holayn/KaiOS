...
module TSOS {
    ...
    export class Kernel {
        ...
        public krnCreateProcess(opcodes){
            var params = opcodes;
            _KernelInterruptQueue.enqueue(new Interrupt(PROCESS_CREATE, params));
        }

        public krnExitProcess(){
            var params;
            _KernelInterruptQueue.enqueue(new Interrupt(PROCESS_EXIT, params));
        }
        ...
        public krnPrintYReg(){
            ...
            _KernelInterruptQueue.enqueue(new Interrupt(CONSOLE_WRITE_IR, params))
        }
